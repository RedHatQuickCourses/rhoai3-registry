...
* **Repository:** You have cloned the course repository:
  `git clone https://github.com/redhat-ai-services/rhoai-3-model-registry-quickstart.git`
  `cd rhoai-3-model-registry-quickstart`
====
...
xref:troubleshooting.adoc[Next: Troubleshooting & Day 2 Operations >]