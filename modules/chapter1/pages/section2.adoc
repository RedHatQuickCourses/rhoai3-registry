...
1. **Manual DB Connection**

The MySQL Database is running, but the Registry does not have the password yet.
Please execute the following command manually to create the DB secret:
