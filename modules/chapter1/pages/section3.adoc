...
Waiting two minutes worked everytime, the following steps are presented here just in case you're impatient.
...
4.  **Success:** You should see the card for **"Qwen3-0.6B"**.
 ...
 * **Dashboard Issue:** Models not visible in the UI.
    ** **Fix:** In the OpenShift AI Model Catalog, check the **Source** filter. Uncheck "Red Hat AI" and ensure "Model-Registry-Lab" (or "All sources") is selected.
