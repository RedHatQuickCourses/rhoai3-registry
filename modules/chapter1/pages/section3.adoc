...
[source,bash]
----
oc get pods -n rhoai-model-registry -l app=model-registry-service
----
...
oc rsh -n rhoai-model-registry deployment/model-registry-service curl -v http://minio.rhoai-model-registry.svc.cluster.local:9000/minio/health/live
----
