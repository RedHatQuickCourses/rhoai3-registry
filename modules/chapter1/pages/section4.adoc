...
data:
  ...
  sources.yaml: |
    catalogs:
      - name: "Training Lab Models"
        id: "lab-custom-models"
        type: "yaml"
        properties:
          yamlCatalogPath: "/data/user-sources/my-models.yaml"
  ...
  my-models.yaml: |
    models:
      ...
      # --- MODEL 2: IBM Granite (Added for clarity) ---
      - name: "granite-7b-lab"
        description: "IBM Granite 7B Base Model"
        customProperties:
          model_type:
            metadataType: MetadataStringValue
            string_value: "generative"
